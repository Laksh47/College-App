...
public class InsertActivity extends Activity {
	...
	public void insert(View clickedbutton)
	{
		...
		if(e1.getText().toString().length()!=0 && e2.getText().length()!=0 && e3.getText().length()!=0 && e4.getText().length()!=0 && e5.getText().length()!=0)
		{
			...
			int i=d.insert(r);
			if(i!=-1)
				Toast.makeText(InsertActivity.this,"Success",Toast.LENGTH_LONG).show();
			else
				Toast.makeText(InsertActivity.this,"Insertion failed",Toast.LENGTH_LONG).show();
			clear();
		}
		else
			Toast.makeText(InsertActivity.this,"Enter field values first!",Toast.LENGTH_LONG).show();
	}
